...
type Stock struct {
	...
	HomeStockCount null.Int `boil:"home_stock_count" json:"home_stock_count,omitempty" toml:"home_stock_count" yaml:"home_stock_count,omitempty"`
	FbaStockCount  null.Int `boil:"fba_stock_count" json:"fba_stock_count,omitempty" toml:"fba_stock_count" yaml:"fba_stock_count,omitempty"`
...
var StockColumns = struct {
	Sku            string
	HomeStockCount string
	FbaStockCount  string
}{
	Sku:            "sku",
	HomeStockCount: "home_stock_count",
	FbaStockCount:  "fba_stock_count",
}
...
var StockTableColumns = struct {
	...
	Sku:            "stock.sku",
	HomeStockCount: "stock.home_stock_count",
	FbaStockCount:  "stock.fba_stock_count",
}
...
var StockWhere = struct {
	...
	HomeStockCount whereHelpernull_Int
	FbaStockCount  whereHelpernull_Int
}{
	Sku:            whereHelperstring{field: "\"stock\".\"sku\""},
	HomeStockCount: whereHelpernull_Int{field: "\"stock\".\"home_stock_count\""},
	FbaStockCount:  whereHelpernull_Int{field: "\"stock\".\"fba_stock_count\""},
}
...
var (
	stockAllColumns            = []string{"sku", "home_stock_count", "fba_stock_count"}
	stockColumnsWithoutDefault = []string{"sku"}
	stockColumnsWithDefault    = []string{"home_stock_count", "fba_stock_count"}
	stockPrimaryKeyColumns     = []string{"sku"}
...
func Stocks(mods ...qm.QueryMod) stockQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"stock\".*"})
	}
...
func FindStock(ctx context.Context, exec boil.ContextExecutor, sku string, selectCols ...string) (*Stock, error) {
	stockObj := &Stock{}
	...
	query := fmt.Sprintf(
		"select %s from \"stock\" where \"sku\"=$1", sel,
	)
...
func (o *Stock) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"stock\" WHERE \"sku\"=$1"
...
func (o *Stock) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindStock(ctx, exec, o.Sku)
	if err != nil {
		return err
	}
...
func StockExists(ctx context.Context, exec boil.ContextExecutor, sku string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"stock\" where \"sku\"=$1 limit 1)"
...
func (o *Stock) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return StockExists(ctx, exec, o.Sku)
}
